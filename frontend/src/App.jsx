...
const WarmingUpSplash = ({ status }) => (
  <div style={{
    ...
    <div style={{
      ...
      <img
        src="/gavel-icon.png" alt="" width={72} height={72}
        style={{
          marginBottom: 16, animation: 'pulse 1.6s ease-in-out infinite',
      ...
      <style>{`@keyframes pulse { 0%, 100% { transform: scale(1); opacity: 1; } 50% { transform: scale(0.92); opacity: 0.8; } }`}</style>
    </div>
  </div>
);
