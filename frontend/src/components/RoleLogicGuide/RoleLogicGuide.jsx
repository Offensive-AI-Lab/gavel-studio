...
const EXAMPLES = [
    ...
    {
        title: 'Financial scam · with a supporting group',
        groups: {
            required: ['send_or_transfer'],
            supporting: ['trust_seeding'],
        },
        condition: 'all of required',
    },
];
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 14 }}>
            <div style={{ background: 'linear-gradient(135deg, rgba(139, 92, 246, 0.14), rgba(99, 102, 241, 0.14))', border: '1px solid rgba(148, 163, 184, 0.18)', borderRadius: 14, padding: 18, lineHeight: 1.6 }}>
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: 8 }}>
                    ...
                    <div style={{ display: 'flex', gap: 8, alignItems: 'flex-start' }}>
                        <span style={tag('#34d399', '#10b981')}>supporting</span>
                        <span style={{ fontSize: '0.85rem', color: '#cbd5e1' }}>a group NOT mentioned in the condition — its CEs are still trained and raise confidence, but never trigger the rule on their own.</span>
                    </div>
                </div>
            </div>
            <div style={{ display: 'flex', flexDirection: 'column', gap: 8 }}>
