...
const RuleCard = ({
    ...
    // "How is this firing logic built?" explainer modal (reuses the wizard's guide).
    ...
    return (
        <div className={`rule-card ${isExpanded ? 'expanded' : ''}`}>
            ...
            <div className="rule-header" onClick={onToggle}>
                ...
                <div className="rule-actions">
                    {/* Drafts can't be bookmarked here — this bookmark path is
                        keyed by public_id (registry identifier), which drafts don't
                ...
                <div className="rule-content">
                    ...
                    <div className="content-label" style={{ display: 'inline-flex', alignItems: 'center', gap: '8px' }}>
                        ...
                        <button
                            ...
                            title="How is this firing logic built?"
                            style={{
            ...
            {/* Firing-logic explainer — the SAME guide shown in the Build-Rule
            ...
            <GlassModal isOpen={logicGuideOpen} onClose={() => setLogicGuideOpen(false)} title="How the firing logic is built" size="wide">
                <RoleLogicGuide />
            </GlassModal>
