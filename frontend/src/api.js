...
// `groups` is { group_name: [ce_id, ...] }; `condition` is the condition grammar
...
// is the condition grammar expression over the group names.
...
// --- Warm remote realtime SESSION (works on any client PC) ---
// Start a warm job (loads the model once on the remote GPU); returns immediately.
