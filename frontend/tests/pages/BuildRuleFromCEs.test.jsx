...
describe('BuildRuleFromCEs', () => {
    ...
    it('supports renaming a group, adding a group, and changing a quantifier', async () => {
        getCEBookmarks.mockResolvedValue({ data: { bookmarks: BOOKMARKS } });
        renderPage();
        await waitLoaded();
        toggleCe('Alpha CE');
        ...
        fireEvent.change(screen.getByLabelText('How much of core must match'),
            { target: { value: '1' } });
        expect(conditionInput()).toHaveValue('1 of core and all of required');
    });
