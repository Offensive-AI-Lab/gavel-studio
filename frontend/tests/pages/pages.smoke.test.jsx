...
describe('Page smoke tests (render without throwing)', () => {
    ...
    it('Workspace renders the welcome layout', async () => {
        ...
        // The dashboard renders a time-based greeting ("Good morning…")
        // followed by the user's name. The kicker badge "GAVEL Studio"
        // is static and always present regardless of dashboard data.
        const badges = await screen.findAllByText(/GAVEL Studio/i);
