...
In earlier multi-user versions of GAVEL, bookmarks followed a user account and
were keyed by the library `public_id`. With login
...
Two consequences of that, both improvements for a single-user install:
  ...
  * You can bookmark a DRAFT. The account-based version couldn't — an unpublished
